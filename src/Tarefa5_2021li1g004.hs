...
draw (Controlador Jogar, (x,y), menu, _, _, _, _, bg,_) = 
    return $ Pictures $ backgrounds (OpcoesNormal, bg) : drawMenu ([[Select, Nada, Nada, Nada, Nada],[Play, Level, Tips, Theme, Exit]], menu) (0,0) 
draw (Controlador Niveis, (x,y), menu, _, _, _, _,bg, _) = 
    return $ Pictures $ backgrounds (OpcoesNormal, bg) : drawMenu ([[Nada, Select, Nada, Nada, Nada],[Play, Level, Tips, Theme, Exit]], menu) (0,0) 
draw (Controlador Instrucoes, (x,y), menu, _, _, _, _,bg, _) = 
    return $ Pictures $ backgrounds (OpcoesNormal, bg) : drawMenu ([[Nada, Nada, Select, Nada, Nada],[Play, Level, Tips, Theme, Exit]], menu) (0,0) 
draw (Controlador Tema, (x,y), menu, _, _, _, _, bg,_) = 
    return $ Pictures $ backgrounds (OpcoesNormal, bg) : drawMenu ([[Nada, Nada, Nada, Select, Nada],[Play, Level, Tips, Theme, Exit]], menu) (0,0) 
draw (Controlador Sair, (x,y), menu, _, _, _, _, bg,_) = 
    return $ Pictures $ backgrounds (OpcoesNormal, bg) : drawMenu ([[Nada, Nada, Nada, Nada, Select],[Play, Level, Tips, Theme, Exit]], menu) (0,0) 
...
draw (Selecionador Nivel1, (x,y), _, _, niveis, _, _, bg,_) =
    return $ Pictures $ backgrounds (NiveisNormal, bg) : drawNiveis ([[Select, Nada, Nada, Nada, Nada], [Lvl1, Lvl2, Lvl3, Lvl4, Lvl5],
...
draw (Selecionador Nivel2, (x,y), _, _, niveis, _, _, bg,_) =
    return $ Pictures $ backgrounds (NiveisNormal, bg) : drawNiveis ([[Nada, Select, Nada, Nada, Nada], [Lvl1, Lvl2, Lvl3, Lvl4, Lvl5],
                                                                       [Nada, Nada, Nada, Nada, Nada], [Lvl6, Lvl7, Lvl8, Lvl9, Lvl10],[Nada,Nada,Nada],[Nada,Nada,Back]], niveis) (0,0) 
draw (Selecionador Nivel3, (x,y), _, _, niveis, _, _,bg, _) =
    return $ Pictures $ backgrounds (NiveisNormal, bg) : drawNiveis ([[Nada, Nada, Select, Nada, Nada], [Lvl1, Lvl2, Lvl3, Lvl4, Lvl5],
                                                                       [Nada, Nada, Nada, Nada, Nada], [Lvl6, Lvl7, Lvl8, Lvl9, Lvl10],[Nada,Nada,Nada],[Nada,Nada,Back]], niveis) (0,0) 
draw (Selecionador Nivel4, (x,y), _, _, niveis, _, _, bg,_) =
    return $ Pictures $ backgrounds (NiveisNormal, bg) : drawNiveis ([[Nada, Nada, Nada, Select, Nada], [Lvl1, Lvl2, Lvl3, Lvl4, Lvl5],
                                                                       [Nada, Nada, Nada, Nada, Nada], [Lvl6, Lvl7, Lvl8, Lvl9, Lvl10],[Nada,Nada,Nada],[Nada,Nada,Back]], niveis) (0,0) 
draw (Selecionador Nivel5, (x,y), _, _, niveis, _, _, bg,_) =
    return $ Pictures $ backgrounds (NiveisNormal, bg) : drawNiveis ([[Nada, Nada, Nada, Nada, Select], [Lvl1, Lvl2, Lvl3, Lvl4, Lvl5],
                                                                       [Nada, Nada, Nada, Nada, Nada], [Lvl6, Lvl7, Lvl8, Lvl9, Lvl10],[Nada,Nada,Nada],[Nada,Nada,Back]], niveis) (0,0) 
